...
const { authenticateUser, retrieveUser, registerUser, searchVehicles, retrieveVehicle, toogleFavVehicle } = require('./logic')
...
app.get('/detail/:id', ({ session: { acceptCookies, token }, params:{id} }, res) =>{
