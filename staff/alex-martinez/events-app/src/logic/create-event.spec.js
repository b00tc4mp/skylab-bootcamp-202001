...
describe('createEvent', () => {
    ...
    let name, surname, email, password, title, description, date, location,token,user, dummyToken
    ...
    it('should fail on non-string or empty token', () => {
        let token = 1
        expect(() => createEvent(token, title, description, location, date)).toThrow(TypeError, `token ${token} is not a string`)
        ...
        token = ''
        expect(() => createEvent(token, title, description, location, date)).toThrow(Error, `token is empty`)
    })

    it('should fail on non-string or empty title', () => {
        let title = 1
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(TypeError, `title ${title} is not a string`)
        ...
        title = ''
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(Error, `title is empty`)
    })

    it('should fail on non-string or empty description', () => {
        let description = 1
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(TypeError, `description ${description} is not a string`)
        ...
        description = ''
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(Error, `description is empty`)
    })

    it('should fail on non-string or empty location', () => {
        let location = 1
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(TypeError, `location ${location} is not a string`)
        ...
        location = ''
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(Error, `location is empty`)
    })

    it('should fail on non-date type or empty date', () => {
        let date = 1
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(TypeError, `date ${date} is not a Date`)
        ...
        date = ''
        expect(() => createEvent(dummyToken, title, description, location, date)).toThrow(Error, `date ${date} is not a Date`)
    })
