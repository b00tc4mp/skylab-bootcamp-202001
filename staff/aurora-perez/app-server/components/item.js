module.exports = function ( props = {}) {
    ...
    return `<li class="results__item favorites__item item" >
        <h3>${name} ${isFav ? `<form action ="/vehicles/fav/${id}" method ="GET"><input type ="hidden"><button>💖</button></form>`: `<form action ="fav/${id}" method ="GET"><input type ="hidden"><button>🤍</button></form>`}</span></h3>
