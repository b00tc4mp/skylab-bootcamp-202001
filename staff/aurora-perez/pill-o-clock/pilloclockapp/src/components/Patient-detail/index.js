...
// import logic, { retrieveProgress, addProgressRecord, retrieveProgressRecord, updateProgress } from '../../logic';
...
//         let index
//         check = (patientProgress.reduce((accum, value) => accum + value, 0))/patientProgress.length
...
//         const {patientId}
//         let patientProgress = await retrieveProgress(patientId)

//         let _markedDates = {}

//         let checkToday = (patientProgress.reduce((accum, value) => accum + value, 0))/patientProgress.length
