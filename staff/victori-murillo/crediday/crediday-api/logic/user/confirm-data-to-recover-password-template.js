module.exports = ({ company, username, code }) => {
  return `<!DOCTYPE html>
  <html lang="es">
    <head>
      <title></title>
    ...
    <div class="container">
      <a href="http://192.168.1.121:3000/login" target="_blank" style="cursor: pointer;">
        <h1 style="color: #303F9F; font-size: 36px;">CrediDay</h1>
      </a>

      <p>Compañia: ${company}</p>
      <p style="margin-bottom: 20px;">Usuario: ${username}</p>

      <h4 style="margin-bottom: 10px;">Código de Verificación</h4>
