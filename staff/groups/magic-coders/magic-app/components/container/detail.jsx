function Detail({card: {multiverseid, name, number, type, rarity, setName, text, cmc, imageUrl}, addToSale, onTo, user}) {
  ...
  return <div className="detail">
      ...
      <div className="detail__title">
        ...
        <button className="detail__button-content__button__add" onClick={() => {event.target.innerHTML = 'In sale'
          addToSale(_card)}}>Add to sale</button>
      </div>
      </div>
      <img className="detail__img" src={imageUrl} />
      <div className="detail__extra">
        <h4 className="detail__extra__text"><b>Card:</b> #{number}</h4>
