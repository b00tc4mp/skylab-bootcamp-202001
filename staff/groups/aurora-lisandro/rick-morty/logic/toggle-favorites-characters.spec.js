            ...
            toggleFavoritesCharacters(token, id, (error, response) => {
                ...
                call(`https://skylabcoders.herokuapp.com/api/v2/users/`, { 
                    ...
                    if(response.content){ 
                        ...
                        const { error, favsCharacter } = user

                        if (error) return done(new Error(error))

                        expect(favsCharacter).toContain(id)
        ...
        describe ('when fav character alredy exists', () => {
            beforeEach(done => {
                ...
                call (`https://skylabcoders.herokuapp.com/api/v2/users/`,{
                    ...
                    body: JSON.stringify({favsCharacter})
                }, (error, response) => {
                    if (error) return done(error)
                ...
                toggleFavoritesCharacters(token, id, (error, response) => {
                    ...
                    call(`https://skylabcoders.herokuapp.com/api/v2/users/`, {
                        ...
                        if(response.content) {
                            ...
                            expect(favsCharacter).not.toContain(id)
