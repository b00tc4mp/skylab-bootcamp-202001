...
describe('retrieveUser', () => {
    ...
    let name, surname, username, password, sessions, time, control, lowTempP, hightTempP, batteryP, heightP, speedP, atmosPressureP, _id
    beforeEach(() => {
        name = `name-${random()}`
    ...
    describe('when user already exists', () => {
        ...
        it('should succeed on correct and valid and right data', () =>
            saveSession(time, control, lowTempP, hightTempP, batteryP, heightP, speedP, atmosPressureP)
